...
let
  cfg = config.uri.hyprland;
in
with lib;
{
  options.uri.hyprland = {
    enable = mkEnableOption "Enables and configures Hyprland";
  };

  imports = [
    # ./hyprconfig/anyrun.nix
    ./hyprconfig/starship.nix
    ./hyprconfig/ags.nix
    ./hyprconfig/theme.nix
  ];
